...
const Experience = () => {
    const experiences = [
        ...
        { year: '2024', title: 'Project Based Internship Program - BTPN Syariah', description: 'As a full stack developer, I created project using Vue.js for the front-end and Golang for the back-end.', logo: BTPNLogo },
